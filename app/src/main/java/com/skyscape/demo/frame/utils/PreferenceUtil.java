...
public class PreferenceUtil {
    ...
    public static void put(String key, Object object) {
        ...
        SharedPreferences sp = ContextUtils.getApplication().getSharedPreferences(FILE_NAME,
                ContextUtils.getApplication().MODE_PRIVATE);
    ...
    public static <T extends Serializable> boolean putByClass(String key, T entity) {
        ...
        SharedPreferences sp = ContextUtils.getApplication().getSharedPreferences(prefFileName, 0);
